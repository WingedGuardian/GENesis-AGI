    ...
    if round_n >= ESCALATION_ROUND_CAP:
        ...
        if not acked:
            _deny(
                ...
                "  (a) HAND IT BACK to a builder session, and stop reviewing. Three "
                ...
                "on, independently, with a falsifier. Then "
        ...
        if not acked:
            _deny(
                ...
                "named case.\n\n"
                "(A) NEEDS REAL EVIDENCE, and the bar is high: findings CONCENTRATING "
                "in one file/function, a finding landing on a line THIS change added in "
                "an earlier round, or the diff GROWING across rounds instead of "
                "shrinking. Absent those it is (B) — the ordinary case is a sound design "
