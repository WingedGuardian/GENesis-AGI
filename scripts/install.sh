...
#   CC_VERSION             — Claude Code version to install (default: 2.1.159)
...
# ══════════════════════════════════════════════════════════════
CC_VERSION="${CC_VERSION:-2.1.159}"  # CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN=1 fixes scrollback (added in PR #479)
