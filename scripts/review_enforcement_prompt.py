...
def main() -> None:
    ...
    print(
        ...
        "reviewer; try the GitHub path first, and vice versa. OBSERVED once (2026-08-27): "
        "the CLI reported a two-week lockout while the GitHub reviewer returned a full "
        "review on the same commit minutes later; the cause (separate metering, plan tier, "
        "or a CLI-side fault) was not established.\n\n"
