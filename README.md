...
- **Agent framework portability** — Genesis fully decoupled from Agent Zero, pluggable into OpenClaw, Hermes Agent, or any agent framework. The cognitive layer is the brain; the runtime is the body. Swap bodies without touching the brain.
