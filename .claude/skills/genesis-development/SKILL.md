...
- **Escalation cap — a HARD BLOCK at 3 rounds that each find NEW defects.**
  ...
  **Class grouping decides HOW you fix — never whether the round counts.** The
  ...
  - Review surfaced a NEW **BLOCKER / SHOULD-FIX / P1 / P2** finding — or a
    genesis-security-reviewer **CRITICAL / WARNING** — → pass `--defects`
    (`python3 scripts/review_state.py mark --agent-output <path> --defects`) — the round counts.
  - Review surfaced **no** new BLOCKER/SHOULD-FIX/P1/P2 (and no security CRITICAL/WARNING) finding → pass `--clean`
  ...
  A round is CLEAN iff the review found no BLOCKER/SHOULD-FIX/P1/P2 and no
  genesis-security-reviewer CRITICAL/WARNING. NOTEs, nitpicks,
