...
class TaskDispatcher:
    ...
    async def submit(
        ...
        *,
        ...
        For user-initiated submissions, intake_token must be provided
        (generated by intake_complete MCP tool during /task intake).
        For internal sources (observation dispatch), a token is
        self-generated — the trust boundary is the server process itself.
    ...
    async def _generate_intake_token(self) -> str:
        """Generate an intake token for internal (non-user) task dispatch."""
